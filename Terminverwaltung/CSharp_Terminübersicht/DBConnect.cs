...
namespace CSharp_Terminübersicht
{
    public class DBConnect
    {
        ...
        public DBConnect()
        {
            try
            {
                Connection = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\MBrinkmann.BKH\Source\Repos\Terminverwaltung\Terminverwaltung\CSharp_Terminübersicht\DB_Termine.accdb");
